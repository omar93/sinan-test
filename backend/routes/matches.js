...
router.get("/", async (req, res) => {
    ...
    const matchesRef = firebase.collection("matches");
...
router.get("/:id", async (req, res) => {
    ...
    const matchesRef = await firebase.collection("matches").doc(id).get();
...
router.post("/", async (req, res) => {
    ...
    const docRef = await firebase.collection("matches").add(object);
